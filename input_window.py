...
def prompt_user():
    ...
    col_1 = StringVar(); dep_1 = StringVar(); crs_1 = StringVar();instr_1 = StringVar(); ttl_1 = StringVar()
    col_2 = StringVar(); dep_2 = StringVar(); crs_2 = StringVar();instr_2 = StringVar(); ttl_2 = StringVar()
    col_3 = StringVar(); dep_3 = StringVar(); crs_3 = StringVar();instr_3 = StringVar(); ttl_3 = StringVar()
    col_4 = StringVar(); dep_4 = StringVar(); crs_4 = StringVar();instr_4 = StringVar(); ttl_4 = StringVar()
    col_5 = StringVar(); dep_5 = StringVar(); crs_5 = StringVar();instr_5 = StringVar(); ttl_5 = StringVar()
    col_6 = StringVar(); dep_6 = StringVar(); crs_6 = StringVar();instr_6 = StringVar(); ttl_6 = StringVar()
    ...
    Label(root, text="Instructor").grid(row=0, column=4)
    Label(root, text="Title").grid(row=0, column=5)
    ...
    instructor_1 = Entry(root,textvariable=instr_1).grid(column=4, row=1)
    title_1 = Entry(root,textvariable=ttl_1).grid(column=5, row=1)
    ...
    instructor_2 = Entry(root,textvariable=instr_2).grid(column=4, row=2)
    title_2 = Entry(root,textvariable=ttl_2).grid(column=5, row=2)
    ...
    instructor_3 = Entry(root,textvariable=instr_3).grid(column=4, row=3)
    title_3 = Entry(root,textvariable=ttl_3).grid(column=5, row=3)
    ...
    instructor_4 = Entry(root,textvariable=instr_4).grid(column=4, row=4)
    title_4 = Entry(root,textvariable=ttl_4).grid(column=5, row=4)
    ...
    instructor_5 = Entry(root,textvariable=instr_5).grid(column=4, row=5)
    title_5 = Entry(root,textvariable=ttl_5).grid(column=5, row=5)
    ...
    instructor_6 = Entry(root,textvariable=instr_6).grid(column=4, row=6)
